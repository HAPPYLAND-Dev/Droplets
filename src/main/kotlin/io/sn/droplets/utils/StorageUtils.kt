...
object StorageUtils {
    ...
    fun createStock(plug: DropletsCore, id: String, name: String) {
    ...
    fun getStock(plug: DropletsCore, id: String): Pair<List<Pair<ItemStack, Double>>, String?> {
        with(File(plug.dataFolder.path + File.separator + "storage" + File.separator + "$id.yml")) {
            if (!exists()) throw IOException("不存在该货架")
